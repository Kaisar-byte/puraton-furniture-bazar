                ...
                <div className=" flex justify-center items-center w-full h-screen p-8">
                    <form onSubmit={handleRegister}>
                        ...
                        <div className="border px-12 py-16 flex flex-col space-y-6 w-[500px]">
                            <input type="text" className="h-14 text-lg pl-4 border bg-white w-full" name="username" placeholder="username" />
                            <input type="email" className="h-14 text-lg pl-4 border bg-white w-full" name="email" placeholder="email" />
                            <input type="password" className="h-14 text-lg pl-4 border bg-white w-full" name="password" placeholder="password" />

                            <div className="flex justify-start border pl-4 gap-6 py-4">
                                <h2>Register as a </h2>
                            ...
                            <div className="flex justify-center">
                                <input type="submit" className="bg-[#E7E7E7] text-black px-5 py-2" value="Submit" />
                            </div>
                            <div>
